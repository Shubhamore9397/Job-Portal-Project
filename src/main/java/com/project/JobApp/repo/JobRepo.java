...
public class JobRepo {
    ...
    List<JobPost> jobs = new ArrayList<>(Arrays.asList(
            ...
            new JobPost(15, "Content Writer", "Create engaging and informative content for websites and publications", 2, List.of("Content Writing", "Copy writing", "SEO", "Creative Writing")),
